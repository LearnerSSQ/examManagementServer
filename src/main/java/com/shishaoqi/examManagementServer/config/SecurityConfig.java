...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http,
        ...
        http
                .csrf(csrf -> csrf
                        .ignoringRequestMatchers("/api/auth/api-login")
                        .disable())
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/training/manage/**").hasRole("EXAM_ADMIN")
                        .requestMatchers("/api/teachers/**").hasAnyRole("ADMIN", "EXAM_ADMIN")
                        .requestMatchers("/teachers/**").hasAnyRole("ADMIN", "EXAM_ADMIN")
                        .requestMatchers("/api/assignments/my/**").hasAnyRole("TEACHER", "EXAM_ADMIN", "ADMIN")
                        .requestMatchers("/api/training/my/**").hasAnyRole("TEACHER", "EXAM_ADMIN", "ADMIN")
